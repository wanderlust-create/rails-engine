...
RSpec.describe 'Item Search with API' do
  context 'GET/ item with FIND' do
    it 'returns a single item which matches the search term' do
      ...
      item1 = Item.create!(name: 'One Item', description: 'one', unit_price: 12.77, merchant_id: merchant1.id)
      item2 = Item.create!(name: 'Two Item', description: 'two', unit_price: 23.11, merchant_id: merchant1.id)
